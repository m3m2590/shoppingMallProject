...
%>
	...
	<script type="text/javascript">
		...
		let json =<%=json %>
		 ...
		 let target_mileSpan = document.getElementById("mileSpan");
		let mileage_flag = "false";
...
$(document).ready(function(){
    $("#checkBoxId").change(function(){
        if($("#checkBoxId").is(":checked")){
            ...
            target_mileSpan.innerHTML = "<%= mvo.getMem_mileage() %> M";
            <%
          ...
          if (rsp.success) {
              ...
              $.ajax({
                    ...
                    success : function(res){
                        pay_no = res.pay_no;
                        location.href="<%=request.getContextPath()%>/showBill.do?pay_no=" + pay_no + "&mileage_flag=" + mileage_flag;
                    },
                    error : function(xhr){
                        alert(xhr.status)   
                    },

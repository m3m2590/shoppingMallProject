...
%>
	   ...
	   <input type="button" value="메뉴로 돌아가기" onclick="qna_list()">
...
<script>
	...
	function qna_list(){
		location.href = "<%=request.getContextPath()%>/QnaAllList.do";
   ...
   request.onreadystatechange = function () {
      if (request.readyState === 4 && request.status === 200) {
         ...
         code += "<tr><td>글번호</td><td>제목</td><td id='qna_writer'>작성자</td><td>작성일</td></tr>";

...
const editPost = function() {
	...
	let code = "<form id='payPostForm'>";
	let code = "<div class='form-group'>";
	code +=	"<label for='memZip'>우편번호 :</label>";
	code +=	"<input";
	code +=	"    type='text'";
	code +=	"    placeholder='Enter zipcode'";
	code +=	"    name='memZip'";
	code +=	"    id='memZip'";
	...
	code +=	"    <input";
	code +=	"        type='text'";
	code +=	"        placeholder='Enter address'";
	code +=	"        name='memAdd1'";
	code +=	"        id='memAdd1'";
	code +=	"        class='form-control'";
	code +=	"    >";
	...
	code +=	"    <input";
	code +=	"        type='text'";
	code +=	"        placeholder='Enter detail address'";
	code +=	"        name='memAdd2'";
	code +=	"        id='memAdd2'";
	code +=	"        class='form-control'";
	code +=	"    >";
...
editBtn.addEventListener("mouseup", editPost);
